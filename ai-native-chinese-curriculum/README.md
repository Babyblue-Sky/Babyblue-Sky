...
2. **Unit Template**（进行中，见 `mandarin-1.2/unit-01-a-day-in-my-life/`）— 目前是 01 Overview / 02 Teaching / 03 Content / 04 Resources / 05 Assessment / 06 AI Workspace / 07 Curriculum Intelligence 七个模块（合并了原本分开的 Projects 和 Assessment，并把 Stories 改名为更广义的 Content，涵盖故事/新闻/音频/歌曲/视频），在 Pilot 中反复验证调整，暂不单独抽出通用模板文档，等 Pilot 稳定后再回头抽象
